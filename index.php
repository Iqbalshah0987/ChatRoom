...
<html lang="en">
  <head>
    ...
    <!-- Favicons -->
    <link rel="icon" href="./img/icons8-chat-60.png">
    ...
    <main>
      <div class="position-relative overflow-hidden p-3 p-md-5 text-center bg-light">
        <div class="col-md-5 p-lg-5 mx-auto my-5">
          <h1 class="display-4 fw-normal">My Anonymous Chat Room</h1>
          ...
          <form action="./claim.php" method="post">
            <label for="" class="mb-2">MyAnonymousChat.com</label>
            <input type="text" name="room" class="border border-1 border-dark">
            <button type="submit" class="btn btn-outline-dark">Claim Room</button>
          </form>
        </div>
